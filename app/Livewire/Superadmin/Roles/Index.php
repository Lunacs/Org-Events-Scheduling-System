        ...
        return Cache::remember('roles_data', $this->cacheDuration, function () {
            return [
                [
                    ...
                    'user_count' => User::where('role', 'superadmin')->count(),
                ...
                [
                    ...
                    'user_count' => User::where('role', 'osa')->count(),
                ...
                [
                    ...
                    'user_count' => User::where('role', 'gso')->count(),
                ...
                [
                    ...
                    'user_count' => User::where('role', 'student_org')->count(),
