...
class TicketAmendedNotification extends Notification implements ShouldBroadcast, ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Ticket Amended - ' . $this->ticket->ticket_number)
            ->view('emails.tickets.ticket-amended', [
                'ticket' => $this->ticket,
    ...
    {
        return [
            'title' => 'Ticket Amended',
            'message' => 'Ticket "' . $this->ticket->title . '" (' . $this->ticket->ticket_number . ') has been amended and resubmitted for review.',
    ...
    private function getActionUrl(object $notifiable): string
    {
        ...
        // OSA users go to ticket review to re-review
