    ...
    <div class="min-h-screen">
        ...
        <x-mary-main full-width>
            ...
            <x-slot:sidebar drawer="main-drawer" collapsible
                class="bg-base-100  lg:bg-inherit rounded-r-xl mx-10">
                ...
                <x-mary-menu separator activate-by-route active-bg-color="bg-neutral" class="font-heading">
                    ...
                    {{-- MENU --}}
                    <x-mary-menu-item title="Dashboard" icon="s-squares-2x2" link="/dashboard" wire:navigate />
                    <x-mary-menu-item title="Event Requests" icon="s-calendar-days" link="/event-req" wire:navigate />
                    <x-mary-menu-item title="Calendar" icon="s-calendar" link="/calendar" wire:navigate />
                    <x-mary-menu-item title="Archives" icon="s-archive-box" link="/archive" wire:navigate />
                    <x-mary-menu-item title="Student Organizations" icon="s-building-office" link="/organizations"
                        wire:navigate />
                    <x-mary-menu-item title="Reports" icon="s-chart-bar" link="/reports" wire:navigate />
                    <x-mary-menu-item title="Users/Accounts" icon="s-users" link="/accounts" wire:navigate />
