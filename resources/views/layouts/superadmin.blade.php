...
<div class="min-h-screen bg-gray-100">
    ...
    <x-mary-main full-width>
        {{-- SIDEBAR --}}
        <x-slot:sidebar drawer="superadmin-drawer" collapsible class="bg-base-100 dark:bg-gray-900 lg:bg-inherit rounded-r-xl">
            ...
            <x-mary-menu separator activate-by-route active-bg-color="bg-accent" class="font-heading">
                <x-mary-menu-item title="Dashboard" icon="o-squares-2x2" link="/superadmin" wire:navigate />
                <x-mary-menu-item title="User Management" icon="o-users" link="/superadmin/users" wire:navigate />
                <x-mary-menu-item title="Roles & Permissions" icon="o-key" link="/superadmin/roles" wire:navigate />
                <x-mary-menu-item title="System Settings" icon="o-cog-6-tooth" link="/superadmin/settings" wire:navigate />
                <x-mary-menu-item title="Transaction Logs" icon="o-clipboard-document-list" link="/superadmin/logs" wire:navigate />
                <x-mary-menu-item title="Archive Management" icon="o-archive-box" link="/superadmin/archive" wire:navigate />
                <x-mary-menu-item title="Reports & Analytics" icon="o-chart-bar" link="/superadmin/reports" wire:navigate />
                ...
                <x-mary-menu-sub title="Account" icon="o-user-circle">
                    ...
                    <x-mary-menu-item title="Go to App" icon="o-arrow-uturn-left" link="/dashboard" wire:navigate />
                </x-mary-menu-sub>
            </x-mary-menu>
        </x-slot:sidebar>
