...
<div x-data="{ show: false }" class="relative items-center">
    <input :type="show ? 'text' : 'password'" wire:model="form.password" @disabled($disabled)
    ...
    <button type="button" @click="show = !show"
        class="absolute inset-y-0 right-0 pr-3 text-gray-600 hover:text-gray-500 dark:hover:text-gray-300 transition-colors duration-300">
