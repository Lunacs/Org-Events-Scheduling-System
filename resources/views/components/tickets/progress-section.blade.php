...
<div class="mb-4 md:hidden">
    ...
    <div class="flex items-center gap-2">
        <div class="w-8 h-8 bg-warning rounded-full flex items-center justify-center">
            <x-mary-icon name="s-clock" class="w-4 h-4 text-warning-content" />
        </div>
    ...
    <div class="flex items-center gap-2">
        <div class="w-8 h-8 bg-success rounded-full flex items-center justify-center">
            <x-mary-icon name="s-check-circle" class="w-4 h-4 text-success-content" />
        </div>
    ...
    <div class="flex items-center gap-2">
        <div class="w-8 h-8 bg-warning rounded-full flex items-center justify-center">
            <x-mary-icon name="s-exclamation-triangle" class="w-4 h-4 text-warning-content" />
        </div>
...
<div class="mb-4 hidden md:block">
    <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
            <div class="w-8 h-8 bg-success rounded-full flex items-center justify-center">
                <x-mary-icon name="s-check" class="w-4 h-4 text-success-content" />
            </div>
        ...
        <div class="flex items-center gap-2">
            <div class="w-8 h-8 bg-base-300 rounded-full flex items-center justify-center">
                <x-mary-icon name="s-clock" class="w-4 h-4 text-base-content/40" />
            </div>
        ...
        <div class="flex items-center gap-2">
            <div class="w-8 h-8 bg-base-300 rounded-full flex items-center justify-center">
                <x-mary-icon name="s-check-circle" class="w-4 h-4 text-base-content/40" />
            </div>
