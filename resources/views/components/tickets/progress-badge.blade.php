...
@if (in_array(strtolower($status), ['received', 'rescheduled', 'amended']))
    <x-mary-badge value="Under Review" class="badge-info text-white" />
@elseif(strtolower($status) == 'gso_review')
    <x-mary-badge value="Under GSO Review" class="badge-info text-white" />
...
@elseif(strtolower($status) == 'needs_revision')
    <x-mary-badge value="Requires Revision" class="badge-warning text-white" />
@elseif(strtolower($status) == 'for_rescheduling')
    <x-mary-badge value="Needs Rescheduling" class="badge-warning text-white" />
