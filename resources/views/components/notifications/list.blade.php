...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
    <x-ui.stat title="Unread" value="{{ $unreadCount }}" icon="s-bell" color="text-error" />
    <x-ui.stat title="Today" value="{{ $todayCount }}" icon="s-clock" color="text-info" />
    <x-ui.stat title="This Week" value="{{ $weekCount }}" icon="s-calendar-days" color="text-success" />
    <x-ui.stat title="Total" value="{{ $totalCount }}" icon="s-archive-box" color="text-secondary" />
</div>
    ...
    <div class="space-y-4">
        ...
        @empty
            <div class="text-center py-12">
                <x-ui.icon name="s-bell" class="w-16 h-16 text-base-content/20 mx-auto mb-4" />
