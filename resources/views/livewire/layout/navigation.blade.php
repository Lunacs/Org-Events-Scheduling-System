                ...
                <x-mary-dropdown right wire:key="nav-profile-dropdown">
                    ...
                    <x-slot:trigger>
                        <div class="btn btn-ghost btn-sm gap-2 hover:bg-base-200 transition-colors">
                            <div wire:key="nav-avatar-{{ $this->user->avatar_style }}-{{ $this->user->avatar_seed }}-{{ $this->user->avatar ?? 'none' }}-{{ $this->user->avatar_preference ?? 'dicebear' }}">
                    ...
                    <div class="w-72 bg-base-100 rounded-box border border-base-300">
                        ...
                        <div class="px-4 py-3 bg-base-200 rounded-t-box border-b border-base-300">
                            <div class="flex items-center gap-3">
                                <div wire:key="dropdown-avatar-{{ $this->user->avatar_style }}-{{ $this->user->avatar_seed }}-{{ $this->user->avatar ?? 'none' }}-{{ $this->user->avatar_preference ?? 'dicebear' }}">
