<div wire:key="avatar-selector-{{ $user->avatar_preference ?? 'dicebear' }}-{{ $this->getProfilePhotoUrl() ? 'photo' : 'no-photo' }}" x-data="{
        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col items-center gap-4 p-6 bg-base-200 rounded-lg">
                        ...
                        <label for="avatar-photo-upload" class="cursor-pointer block">
                            ...
                            <div>
                                ...
                                <div class="avatar placeholder">
                                    <div class="bg-base-300 rounded-full w-32 h-32 ring-4 ring-primary ring-offset-2 ring-offset-base-100 relative overflow-hidden">
                                        @if ($photo)
                ...
                <div class="flex gap-2 mt-3 justify-center">
                    ...
                    <x-mary-button wire:click="cancelPhotoUpload" icon="o-x-mark"
        ...
        <div>
            <h3 class="text-lg font-semibold mb-4 flex items-center gap-2">
                ...
                <span class="badge badge-neutral badge-sm">
                    <a href="https://www.dicebear.com/" target="_blank" class="hover:underline">from dicebear</a>
                </span>
            </h3>
                ...
                <div @click="selectUploadedPhoto()" class="cursor-pointer group">
                    <div class="relative">
                        ...
                        <template x-if="selectedType === 'uploaded'">
                            <div class="absolute -top-1 -right-1 bg-primary text-primary-content rounded-full p-1 shadow-lg">
