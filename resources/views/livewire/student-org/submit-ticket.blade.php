<div>
    ...
    <x-mary-card title="Organization Information" subtitle="Details about your student organization">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <x-mary-input label="Contact of Adviser" wire:model.live.debounce.500ms="adviser_contact" required />
        </div>
    </x-mary-card>
    @endif
    ...
    <div class="flex justify-between items-center pt-6">
        ...
        < $totalSteps)
            ...
            class="btn-primary {{ ($errors->any() || !$this->isCurrentStepComplete) ? '<opacity-75></opacity-75> cursor-not-allowed' : '' }}"
            :disabled="$errors->any() || !$this->isCurrentStepComplete" />
        @else
        <x-mary-button label="Submit Ticket" icon="s-paper-airplane" type="submit"
            x-on:click="isSubmitting = true" spinner
