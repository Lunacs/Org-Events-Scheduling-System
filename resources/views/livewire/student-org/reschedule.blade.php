                ...
                <div class="bg-base-100 rounded-box shadow-lg p-6">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p class="text-base-content/70 mt-1">Reschedule a ticket of your organization's event request
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center pt-6">
                    ...
                    @if ($currentStep < $totalSteps)
                        <x-mary-button label="Next" icon="o-arrow-right" wire:click="nextStep" class="btn-primary"
                            ...
                            wire:target="nextStep" spinner :disabled="$isProcessing || (!$changeDate && !$changeTime && !$changeVenue)" />
                    @else
                        <x-mary-button label="Submit Reschedule Request" icon="s-paper-airplane" type="submit"
