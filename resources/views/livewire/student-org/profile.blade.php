                        ...
                        <div class="flex items-center justify-between p-4 bg-base-200 rounded-lg">
                            <div class="flex items-center gap-3">
                                <div class="bg-secondary/10 p-2 rounded-full">
                                    <x-mary-icon name="o-calendar" class="w-5 h-5 text-secondary" />
                                </div>
                                <div>
                                    <h4 class="font-semibold">Event Reminders</h4>
                                    <p class="text-sm text-base-content/70">Receive reminders for upcoming events</p>
                                </div>
                            </div>
                            <x-mary-toggle wire:model.live="event_reminders" class="toggle-secondary" />
                        </div>
                    </div>
