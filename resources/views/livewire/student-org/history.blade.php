    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <x-mary-stat title="Total Events" description="All time" value="24" icon="s-calendar-days"
                    color="text-primary" />

                <x-mary-stat title="Approved" description="Success rate: 83%" value="20" icon="s-check-circle"
                    color="text-success" />

                <x-mary-stat title="Rejected" description="17% of submissions" value="4" icon="s-x-circle"
                    color="text-error" />

                <x-mary-stat title="Avg. Processing" description="Days to approval" value="5.2" icon="s-clock"
                    color="text-info" />
            </div>
            ...
            <x-mary-card>
                <div class="flex flex-wrap gap-4 items-end">
                    <x-mary-input label="Search Events" wire:model.live="search"
                        placeholder="Search by title, description, or venue..." icon="s-magnifying-glass"
                    ...
                    <x-mary-select label="Event Type" wire:model.live="typeFilter" :options="[
                        ['id' => '', 'name' => 'All Types'],
                    ...
                    <x-mary-select label="Year" wire:model.live="yearFilter" :options="[
                        ['id' => '', 'name' => 'All Years'],
                        ['id' => '2025', 'name' => '2025'],
                        ['id' => '2024', 'name' => '2024'],
                        ['id' => '2023', 'name' => '2023'],
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 mb-3">Three-day intensive workshop on leadership skills and
                                    organizational management for student officers.</p>
                            ...
                            <div class="flex flex-col space-y-2 ml-6">
                                ...
                                <x-mary-button icon="o-photo" class="btn-sm btn-ghost" tooltip="View Photos" />
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 p-4 rounded-lg border-l-4 border-green-400">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-green-700 mt-1">Excellent turnout with 90% attendance rate.
                                        Participants rated the workshop 4.8/5. Generated ₱2,000 in additional membership
                                        fees.</p>
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 mb-3">Large-scale outdoor music festival featuring local bands
                                    and food vendors to raise funds for community projects.</p>
                        ...
                        <div class="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-red-600 mt-2">Suggestion: Consider a smaller, indoor
                                        alternative or partner with experienced organizations</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 mb-3">Annual meeting for all organization members to review
                                    yearly accomplishments and elect new officers.</p>
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-blue-700 mt-1">Record high attendance (97.5%). Successfully
                                        elected new officers. Approved budget increase for next year. Received
                                        commendation from university administration.</p>
                    ...
                    <div class="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow opacity-75">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 mb-3">Career fair connecting students with potential employers
                        ...
                        <div class="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-yellow-700 mt-1">Event cancelled due to insufficient
                                        employer participation (only 3 out of 15 expected companies confirmed). Refunds
                                        processed for all advance payments.</p>
                                    <p class="text-xs text-yellow-600 mt-2">Learning: Start employer recruitment
                                        earlier and have contingency plans</p>
                                </div>
                            </div>
                        </div>
                    </div>
