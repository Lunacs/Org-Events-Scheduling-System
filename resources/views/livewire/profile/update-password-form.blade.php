...
<section>
    ...
    <form wire:submit="updatePassword" class="mt-6 space-y-6">
        <div>
            ...
            <x-forms.text-input wire:model="current_password" id="update_password_current_password" name="current_password"
        ...
        <div>
            ...
            <x-forms.text-input wire:model="password" id="update_password_password" name="password" type="password"
        ...
        <div>
            ...
            <x-forms.text-input wire:model="password_confirmation" id="update_password_password_confirmation"
