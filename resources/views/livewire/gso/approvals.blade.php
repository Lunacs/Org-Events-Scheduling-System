                                    ...
                                    <div class="flex flex-col gap-2 w-full">
                                        ...
                                        @if ($approval['ticket_id'])
                                            <x-mary-button label="Details" icon="s-eye"
                                                class="btn-sm btn-outline btn-emerald w-full" link="{{ route('gso.ticket-details', ['ticket' => $approval['ticket_id'], 'office' => $approval['office_id'] ?? null, 'approval' => $approval['id'] ?? null]) }}"
                                                wire:navigate />
                                        @else
                                            <x-mary-button label="Details" icon="s-eye"
