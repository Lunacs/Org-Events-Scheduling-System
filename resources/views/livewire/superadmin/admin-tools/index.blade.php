<div>
    <div class="p-6 space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold font-heading">Admin Tools</h1>
                <p class="text-sm text-base-content/60 mt-1">System maintenance and management utilities</p>
            </div>
            <x-mary-button icon="o-arrow-path" class="btn-outline" wire:click="loadSystemStatus; $refresh">
                Refresh
            </x-mary-button>
        </div>
