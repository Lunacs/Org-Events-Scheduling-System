<div>
    ...
    <x-mary-card shadow class="border-none bg-slate-50/50 dark:bg-base-100/50">
        ...
        <div class="flex flex-col gap-4 mb-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 class="text-lg sm:text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                        <x-mary-icon name="o-document-text" class="w-6 h-6 text-primary-500" />
                        Content Sections
                    </h2>
            ...
            <div
                ...
                <div class="flex-1">
                    <x-mary-input wire:model.live.debounce.300ms="search" placeholder="Search by title or key..."
                        icon="o-magnifying-glass" class="input-sm" clearable />
                </div>
                <div class="sm:w-48">
                    <x-mary-select wire:model.live="filterType" :options="$sectionTypes" placeholder="All Content Types"
                    ...
                    <div
                        ...
                        <div class="flex items-start gap-4 min-w-0 flex-1">
                            ...
                            <div
                                ...
                                <x-mary-icon name="{{ $section->type_icon }}" class="w-6 h-6" />
                            </div>
                        ...
                        <div class="flex items-center gap-2 shrink-0 self-end sm:self-center">
                            {{-- Preview Button --}}
                            <x-mary-button size="sm" icon="o-eye"
                            ...
                            <x-mary-button size="sm" icon="{{ $section->is_active ? 'o-eye-slash' : 'o-eye' }}"
                            ...
                            {{-- Delete Button --}}
                            <x-mary-button size="sm" icon="o-trash"
        ...
        @else
            ...
            <div
                ...
                <div
                    ...
                    <x-mary-icon name="o-document-text" class="w-8 h-8 text-slate-400 dark:text-slate-500" />
                </div>
    ...
    @if ($previewSection)
        <x-mary-modal wire:model="previewModalOpen" title="{{ $previewSection->title }}" subtitle="Content Preview"
            ...
            <div class="p-4 bg-slate-50 dark:bg-base-200 rounded-xl">
                ...
                <div class="flex items-center gap-3 mb-4 pb-4 border-b border-slate-200 dark:border-base-300">
                    <div
                        ...
                        <x-mary-icon name="{{ $previewSection->type_icon }}" class="w-5 h-5" />
                    </div>
                    <div>
            ...
            <x-slot:actions>
                <x-mary-button label="Close" @click="$wire.closePreview()" />
    ...
    @if ($deletingId)
        <x-mary-modal wire:model="deleteModalOpen" title="Delete Content Section"
            ...
            <div class="space-y-4">
                <div
                    ...
                    <div
                        ...
                        <x-mary-icon name="o-exclamation-triangle" class="w-5 h-5 text-red-600 dark:text-red-400" />
                    </div>
                    <div>
            ...
            <x-slot:actions>
                <x-mary-button label="Cancel" @click="$wire.deleteModalOpen = false; $wire.resetDeleteModal()"
                    class="btn-ghost" />
                <x-mary-button label="Delete Permanently" wire:click="confirmDelete" class="btn-error"
