<div>
    <x-ui.card shadow class="border-none bg-slate-50/50 dark:bg-base-100/50">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <x-ui.button icon="o-plus" label="New Venue" class="btn-primary btn-sm shadow-sm w-full sm:w-auto"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 min-w-0">
                            <div
                                ...
                                <x-ui.icon name="o-map-pin" class="w-5 h-5 sm:w-6 sm:h-6" />
                            </div>
                            <div class="min-w-0">
                                ...
                                @if ($venue->venue_location)
                                    <p
                                        ...
                                        <x-ui.icon name="o-building-office-2" class="w-3 h-3 inline-block mr-1" />
                        ...
                        <div
                            ...
                            <x-ui.button size="xs" :icon="$venue->is_active ? 'o-eye' : 'o-eye-slash'"
        ...
        @else
            <div
                ...
                <x-ui.icon name="o-map-pin" class="w-12 h-12 mx-auto mb-3 text-slate-300 dark:text-slate-600" />
    ...
    {{-- Delete Venue Modal --}}
    @if ($deletingVenueId)
        <x-ui.modal-dialog wire:model="deleteModalOpen" title="Delete Venue" subtitle="Confirm deletion" separator
            ...
            <x-slot:actions>
                ...
                <x-ui.button label="Delete" wire:click="confirmDelete" class="btn-error" :disabled="$hasAssociatedTickets"
