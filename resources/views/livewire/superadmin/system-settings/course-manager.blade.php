<div>
    <x-mary-card shadow class="border-none bg-slate-50/50 dark:bg-base-100/50">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <x-mary-button icon="o-plus" label="Add New" class="btn-primary btn-sm shadow-sm w-full sm:w-auto"
        ...
        @else
            <div
                ...
                <x-mary-icon name="o-academic-cap" class="w-12 h-12 mx-auto mb-3 text-slate-300 dark:text-slate-600" />
    ...
    <x-mary-modal wire:model="addCourseModalOpen" title="Add Course" subtitle="Create a new course" separator
        ...
        <form wire:submit.prevent="addCourse" class="space-y-4">
            <x-mary-input wire:model="newCourseCode" label="Course Code" placeholder="e.g., BSIT" icon="o-hashtag" />
    ...
    @if ($editingCourseId)
        <x-mary-modal wire:model="editCourseModalOpen" title="Edit Course" subtitle="Update course information"
            ...
            <form wire:submit.prevent="editCourse" class="space-y-4">
                <x-mary-input wire:model="courseCode" label="Course Code" placeholder="e.g., BSIT" icon="o-hashtag" />
            ...
            <x-slot:actions>
                <x-mary-button label="Cancel" @click="$wire.editCourseModalOpen = false; $wire.resetEditCourseForm()" />
