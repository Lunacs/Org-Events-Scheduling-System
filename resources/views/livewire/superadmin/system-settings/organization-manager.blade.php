            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                    ...
                    <x-mary-button icon="o-x-mark" class="btn-ghost btn-sm"
                        wire:click="$set('newOrgLogo', null)" />
                </div>
                @endif
            </div>
        </form>
        ...
        <form wire:submit.prevent="editOrganization" class="space-y-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                    ...
                    <x-mary-button icon="o-trash" class="btn-ghost btn-error btn-sm"
            ...
            <div class="space-y-2">
                ...
                {{-- Loading indicator --}}
                <div wire:loading wire:target="orgLogo" class="flex items-center gap-2 text-sm text-base-content/70">
                    <span class="loading loading-spinner loading-sm"></span>
                    <span>Processing image...</span>
                </div>
