...
new #[Layout('components.layouts.guest')] class extends Component {
    ...
    public function login(): void
    {
        ...
        try {
            ...
            TransactionLogService::logAuthEvent('login_failed', null, "Failed GSO login attempt for email: {$this->form->email}");
            throw $e;
        }
        ...
        if (!$user->isGSO()) {
            ...
            TransactionLogService::logAuthEvent('unauthorized_access', $user, 'Non-GSO user attempted GSO login');
            Auth::guard()->logout();
        ...
        TransactionLogService::logAuthEvent('login', $user, 'GSO portal login');
