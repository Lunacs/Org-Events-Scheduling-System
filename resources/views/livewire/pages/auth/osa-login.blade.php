    ...
    public function login(): void
    {
        ...
        if (!$user->isOSA()) {
            ...
            throw ValidationException::withMessages([
                'form.email' => 'You are not authorized to access the OSA portal.',
            ]);
        }
...
<div>
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white">OSA Login</h2>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">Office of Student Affairs Portal</p>
    </div>
