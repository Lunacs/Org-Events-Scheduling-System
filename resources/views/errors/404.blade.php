    ...
    <div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-4">
        <div class="max-w-2xl w-full">
            ...
            <div class="bg-base-100 rounded-box shadow-xl overflow-hidden">
                ...
                <div class="bg-info px-6 py-8 sm:px-10 sm:py-12 text-center">
                    <div
                        class="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 bg-base-100 rounded-full mb-4">
                        <i class="fas fa-file-circle-question text-info text-4xl sm:text-5xl"></i>
                    </div>
                    <h1 class="text-3xl sm:text-4xl font-heading font-bold text-info-content mb-2">
                        Page Not Found
                    </h1>
                    <p class="text-lg sm:text-xl text-info-content opacity-90">
                        Error 404 - Not Found
                    </p>
                </div>
