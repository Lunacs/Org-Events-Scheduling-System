        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Submit a request to change the date, time, or venue of your approved event</p>
                </div>
                <x-mary-button
                    label="My Tickets"
                    icon="s-ticket"
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="text-sm">
                            ...
                            <ul class="list-disc list-inside space-y-1 text-gray-600">
                                <li>Reschedule requests must be submitted at least 7 days before the current event date</li>
            ...
            <x-mary-card title="Select Event to Reschedule" subtitle="Choose from your approved events">
                <div class="space-y-4">
                    <x-mary-select
                        ...
                        placeholder="Select an event to reschedule"
                        required />
            ...
            <x-mary-form wire:submit="submitReschedule">
                ...
                <x-mary-card title="What needs to be changed?" subtitle="Select the type of change you need">
                    <div class="space-y-3">
                        <x-mary-checkbox
                            label="Change Date"
                            wire:model.live="changeDate" />

                        <x-mary-checkbox
                            label="Change Time"
                            wire:model.live="changeTime" />

                        <x-mary-checkbox
                            label="Change Venue"
                            wire:model.live="changeVenue" />
                    </div>
                </x-mary-card>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-mary-datetime
                                ...
                                wire:model="newStartDateTime"
                                required />

                            <x-mary-datetime
                                label="New End Date & Time"
                                wire:model="newEndDateTime"
                                required />
                        </div>
                        @endif
                ...
                <x-mary-card title="Urgency Level" subtitle="How urgent is this reschedule request?">
                    <div class="space-y-4">
                        <x-mary-radio
                            label="Normal - Standard processing time (5-7 business days)"
                            wire:model="urgencyLevel"
                            value="normal" />

                        <x-mary-radio
                            label="Urgent - Expedited processing needed (2-3 business days)"
                            wire:model="urgencyLevel"
                            value="urgent" />

                        <x-mary-radio
                            label="Emergency - Immediate attention required (within 24 hours)"
                            wire:model="urgencyLevel"
                            value="emergency" />

                        @if($urgencyLevel === 'urgent' || $urgencyLevel === 'emergency')
                        <x-mary-textarea
                            label="Justification for Urgency"
                            wire:model="urgencyJustification"
            ...
            <x-mary-card title="Recent Reschedule Requests" subtitle="Your previous reschedule request history">
                <div class="space-y-4">
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between items-start">
                                <div>
                                    ...
                                    <p class="text-sm text-green-700 mt-1">Venue changed from Room 301 to Library Hall</p>
                                    <p class="text-xs text-green-600 mt-2">Requested: Sep 20, 2025 • Approved: Sep 22, 2025</p>
                                </div>
                                <x-mary-badge value="Approved" class="badge-success" />
                            </div>
                            <p class="text-sm text-green-600 mt-2">Reason: Original venue had technical issues with audio equipment</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-yellow-600 mt-2">Reason: Conflict with another major university event</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center">
                    <x-mary-button
                        label="View All Reschedule History"
                        icon="s-clock"
