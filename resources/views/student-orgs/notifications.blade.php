        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <x-mary-card>
                <div class="space-y-4">
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-green-50 rounded-lg border-l-4 border-green-400 hover:shadow-md transition-shadow">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-green-700 mt-1">Your event request for "Fundraising Concert" scheduled on November 1, 2025, has been approved by both OSA and GSO. You can now proceed with your event preparations.</p>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-400 hover:shadow-md transition-shadow">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <p class="font-semibold text-orange-900">Revision Required: Skills Workshop Series</p>
                                    <p class="text-sm text-orange-700 mt-1">Your event request needs additional information. Please provide more details about the workshop facilitators, their qualifications, and a detailed schedule for each day.</p>
                                    <div class="mt-3 p-2 bg-orange-100 rounded">
                                        <p class="text-xs text-orange-800 font-medium">Action Required:</p>
                                        <p class="text-xs text-orange-700">Please update your ticket with the requested information within 5 days.</p>
                                    </div>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400 hover:shadow-md transition-shadow opacity-75">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <p class="font-semibold text-blue-900">Under Review: Annual Organization Meeting</p>
                                    <p class="text-sm text-blue-700 mt-1">Your event proposal looks good. Please provide the list of expected attendees with their contact information for security purposes.</p>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-400 hover:shadow-md transition-shadow">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-yellow-700 mt-1">Your approved event "Fundraising Concert" is scheduled for November 1, 2025 (in 5 days). Don't forget to submit your final preparation checklist and post-event report.</p>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-purple-50 rounded-lg border-l-4 border-purple-400 hover:shadow-md transition-shadow">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-purple-700 mt-1">Your reschedule request for "Workshop Series" has been approved. The event venue has been changed from Room 301 to Library Hall due to technical issues.</p>
                    ...
                    <div class="flex items-start space-x-4 p-4 bg-gray-50 rounded-lg border-l-4 border-gray-400 hover:shadow-md transition-shadow opacity-75">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-700 mt-1">New guidelines for student organization events have been released. Please review the updated safety protocols and submission requirements before your next event request.</p>
