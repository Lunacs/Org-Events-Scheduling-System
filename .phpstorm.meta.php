...
'rich-text-laravel.editors.trix','tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project',);
...
'dashboard','keep-alive','attachments.preview','attachments.download','email.verify-new',
...
'superadmin.archive','superadmin.reports','superadmin.notifications','superadmin.system-settings','superadmin.content-section.create',
'superadmin.content-section.edit','superadmin.event-type.create','superadmin.event-type.edit','superadmin.venue.create','superadmin.venue.edit',
'superadmin.faqs','superadmin.faq.create','superadmin.faq.edit','superadmin.admin-tools','superadmin.logs',
'superadmin.profile','gso.dashboard','gso.ticket-review','gso.ticket-details','gso.calendar',
'gso.notifications','gso.communication','gso.reports','gso.reports.export','gso.profile',
'student-org.dashboard','student-org.submit-ticket','student-org.my-tickets','student-org.ticket-details','student-org.calendar',
...
'components.ui.secondary-button','components.ui.section-header','emails.email-change-requested','emails.password-changed','emails.reset-password',
'emails.tickets.gso-approved','emails.tickets.gso-for-revision','emails.tickets.gso-rejected','emails.tickets.ticket-amended','emails.tickets.ticket-approved',
'emails.tickets.ticket-comment','emails.tickets.ticket-for-revision','emails.tickets.ticket-forwarded-gso','emails.tickets.ticket-rejected','emails.tickets.ticket-revision-requested',
'emails.tickets.ticket-status-updated','emails.tickets.ticket-submitted','emails.verify-email','emails.verify-new-email','errors.401',
'errors.402','errors.403','errors.404','errors.419','errors.429',
'errors.500','errors.503','errors.layout','errors.minimal','livewire.about-us',
...
'livewire.superadmin.system-settings.partials.organization-card','livewire.superadmin.system-settings.venue-editor','livewire.superadmin.system-settings.venue-manager','livewire.superadmin.tickets.index','livewire.superadmin.users.index',
'osa.welcome','reports.events-pdf','reports.gso.summary-pdf','reports.osa.summary-pdf','superadmin.archive',
'superadmin.dashboard','superadmin.logs','superadmin.reports','superadmin.roles','superadmin.settings',
'superadmin.users','volt-livewire::about-us','volt-livewire::avatar-selector','volt-livewire::components.event-calendar','volt-livewire::components.event-calendar-scripts',
'volt-livewire::components.ticket-comments','volt-livewire::faq','volt-livewire::gso.calendar','volt-livewire::gso.dashboard','volt-livewire::gso.details',
'volt-livewire::gso.notifications','volt-livewire::gso.profile','volt-livewire::gso.reports','volt-livewire::gso.ticket-review','volt-livewire::layout.navigation',
'volt-livewire::notification-dropdown','volt-livewire::osa.archive','volt-livewire::osa.archived-event-details','volt-livewire::osa.communication','volt-livewire::osa.dashboard',
'volt-livewire::osa.notifications','volt-livewire::osa.placeholders.communication','volt-livewire::osa.placeholders.dashboard','volt-livewire::osa.placeholders.event-calendar','volt-livewire::osa.placeholders.notifications',
'volt-livewire::osa.placeholders.stats-grid','volt-livewire::osa.placeholders.table','volt-livewire::osa.placeholders.ticket-cards','volt-livewire::osa.placeholders.ticket-management','volt-livewire::osa.placeholders.ticket-review',
'volt-livewire::osa.profile','volt-livewire::osa.reports','volt-livewire::osa.ticket-management','volt-livewire::osa.ticket-review.index','volt-livewire::osa.ticket-review.show',
...
'volt-livewire::pages.auth.verify-email','volt-livewire::placeholders.notification-list','volt-livewire::profile.delete-user-form','volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form',
'volt-livewire::student-org.dashboard','volt-livewire::student-org.edit-ticket','volt-livewire::student-org.history','volt-livewire::student-org.my-ticket','volt-livewire::student-org.notifications',
'volt-livewire::student-org.profile','volt-livewire::student-org.reschedule','volt-livewire::student-org.submit-ticket','volt-livewire::student-org.ticket-details','volt-livewire::superadmin.admin-tools.index',
'volt-livewire::superadmin.archive.index','volt-livewire::superadmin.calendar.index','volt-livewire::superadmin.dashboard','volt-livewire::superadmin.faq-editor','volt-livewire::superadmin.faq-manager',
'volt-livewire::superadmin.logs','volt-livewire::superadmin.notifications','volt-livewire::superadmin.placeholders.dashboard','volt-livewire::superadmin.placeholders.logs','volt-livewire::superadmin.placeholders.notifications',
'volt-livewire::superadmin.placeholders.reports','volt-livewire::superadmin.placeholders.users','volt-livewire::superadmin.profile','volt-livewire::superadmin.reports.index','volt-livewire::superadmin.roles.index',
'volt-livewire::superadmin.system-settings.content-section-editor','volt-livewire::superadmin.system-settings.content-section-manager','volt-livewire::superadmin.system-settings.course-manager','volt-livewire::superadmin.system-settings.event-type-editor','volt-livewire::superadmin.system-settings.event-type-manager',
'volt-livewire::superadmin.system-settings.index','volt-livewire::superadmin.system-settings.organization-manager','volt-livewire::superadmin.system-settings.partials.organization-card','volt-livewire::superadmin.system-settings.venue-editor','volt-livewire::superadmin.system-settings.venue-manager',
'volt-livewire::superadmin.tickets.index','volt-livewire::superadmin.users.index','71ffe14e2608a75a2cb5aed52d105549::styles','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'pagination::simple-tailwind','pagination::tailwind','rich-text-laravel::attachables._content','rich-text-laravel::attachables._image_gallery','rich-text-laravel::attachables._missing_attachable',
'rich-text-laravel::attachables._remote_file','rich-text-laravel::attachables._remote_image','rich-text-laravel::attachment_galleries._attachment_gallery','rich-text-laravel::components.styles','rich-text-laravel::content',);
