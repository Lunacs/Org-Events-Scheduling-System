...
'livewire.preview-file','mary.toogle-sidebar','mary.spotlight','mary.upload','about-us','profile','dashboard','keep-alive',
...
'superadmin.reports','superadmin.notifications','superadmin.system-settings','superadmin.admin-tools','superadmin.logs',
...
'student-org.dashboard','student-org.submit-ticket','student-org.my-tickets','student-org.calendar','student-org.reschedule',
'student-org.notifications','student-org.history','student-org.profile','admin.login','student-org.login',
'gso.login','superadmin.login','login','register','password.request',
'password.reset','verification.notice','verification.verify','password.confirm','logout',
'storage.local',);
        registerArgumentsSet('views', 
'components.app-layout','components.comment-boxes.normal-comment','components.comment-boxes.ticket-comments','components.dashboard.quick-action-card','components.dashboard.stat-card',
'components.footer','components.forms.email-input','components.forms.input-error','components.forms.input-label','components.forms.password-input',
'components.forms.text-input','components.layouts.app','components.layouts.gso-layout','components.layouts.guest','components.layouts.student-org-layout',
...
'components.tickets.ticket-pagination','components.tickets.ticket-preview','components.tickets.ticketinfo','components.tickets.upc-events-card','components.ui.action-message',
...
'components.ui.section-header','emails.reset-password','emails.tickets.gso-approved','emails.tickets.gso-rejected','emails.tickets.ticket-amended',
'emails.tickets.ticket-approved','emails.tickets.ticket-comment','emails.tickets.ticket-forwarded-gso','emails.tickets.ticket-rejected','emails.tickets.ticket-revision-requested',
'emails.tickets.ticket-status-updated','emails.tickets.ticket-submitted','emails.verify-email','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','livewire.about-us','livewire.avatar-selector',
'livewire.components.event-calendar','livewire.components.event-calendar-scripts','livewire.components.ticket-comments','livewire.gso.calendar','livewire.gso.dashboard',
...
'livewire.osa.placeholders.notifications','livewire.osa.placeholders.stats-grid','livewire.osa.placeholders.table','livewire.osa.placeholders.ticket-management','livewire.osa.profile',
'livewire.osa.reports','livewire.osa.ticket-management','livewire.osa.ticket-review.index','livewire.osa.ticket-review.show','livewire.pages.auth.confirm-password',
'livewire.pages.auth.forgot-password','livewire.pages.auth.gso-login','livewire.pages.auth.login','livewire.pages.auth.osa-login','livewire.pages.auth.register',
'livewire.pages.auth.reset-password','livewire.pages.auth.student-org-login','livewire.pages.auth.superadmin-login','livewire.pages.auth.verify-email','livewire.profile.delete-user-form',
'livewire.profile.update-password-form','livewire.profile.update-profile-information-form','livewire.session-timeout','livewire.student-org.dashboard','livewire.student-org.edit-ticket',
...
'livewire.student-org.submit-ticket','livewire.superadmin.admin-tools.index','livewire.superadmin.archive.index','livewire.superadmin.calendar.index','livewire.superadmin.dashboard',
'livewire.superadmin.logs','livewire.superadmin.notifications','livewire.superadmin.placeholders.notifications','livewire.superadmin.profile','livewire.superadmin.reports.index',
'livewire.superadmin.roles.index','livewire.superadmin.system-settings.course-manager','livewire.superadmin.system-settings.event-type-manager','livewire.superadmin.system-settings.index','livewire.superadmin.system-settings.organization-manager',
'livewire.superadmin.tickets.index','livewire.superadmin.users.index','osa.welcome','reports.events-pdf','reports.gso.summary-pdf',
'reports.osa.summary-pdf','superadmin.archive','superadmin.dashboard','superadmin.logs','superadmin.reports',
'superadmin.roles','superadmin.settings','superadmin.users','volt-livewire::about-us','volt-livewire::avatar-selector',
'volt-livewire::components.event-calendar','volt-livewire::components.event-calendar-scripts','volt-livewire::components.ticket-comments','volt-livewire::gso.calendar','volt-livewire::gso.dashboard',
'volt-livewire::gso.details','volt-livewire::gso.notifications','volt-livewire::gso.profile','volt-livewire::gso.reports','volt-livewire::gso.ticket-review',
'volt-livewire::layout.navigation','volt-livewire::notification-dropdown','volt-livewire::osa.archive','volt-livewire::osa.archived-event-details','volt-livewire::osa.communication',
'volt-livewire::osa.dashboard','volt-livewire::osa.notifications','volt-livewire::osa.placeholders.communication','volt-livewire::osa.placeholders.dashboard','volt-livewire::osa.placeholders.event-calendar',
'volt-livewire::osa.placeholders.notifications','volt-livewire::osa.placeholders.stats-grid','volt-livewire::osa.placeholders.table','volt-livewire::osa.placeholders.ticket-management','volt-livewire::osa.profile',
...
'volt-livewire::pages.auth.forgot-password','volt-livewire::pages.auth.gso-login','volt-livewire::pages.auth.login','volt-livewire::pages.auth.osa-login','volt-livewire::pages.auth.register',
'volt-livewire::pages.auth.reset-password','volt-livewire::pages.auth.student-org-login','volt-livewire::pages.auth.superadmin-login','volt-livewire::pages.auth.verify-email','volt-livewire::profile.delete-user-form',
...
'volt-livewire::superadmin.logs','volt-livewire::superadmin.notifications','volt-livewire::superadmin.placeholders.notifications','volt-livewire::superadmin.profile','volt-livewire::superadmin.reports.index',
'volt-livewire::superadmin.roles.index','volt-livewire::superadmin.system-settings.course-manager','volt-livewire::superadmin.system-settings.event-type-manager','volt-livewire::superadmin.system-settings.index','volt-livewire::superadmin.system-settings.organization-manager',
'volt-livewire::superadmin.tickets.index','volt-livewire::superadmin.users.index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
