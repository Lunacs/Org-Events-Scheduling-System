...
'livewire.student-org.ticket-details','livewire.superadmin.admin-tools.index','livewire.superadmin.archive.index','livewire.superadmin.calendar.index','livewire.superadmin.dashboard',
'livewire.superadmin.faq-editor','livewire.superadmin.faq-manager','livewire.superadmin.logs','livewire.superadmin.notifications','livewire.superadmin.placeholders.dashboard',
'livewire.superadmin.placeholders.logs','livewire.superadmin.placeholders.notifications','livewire.superadmin.placeholders.reports','livewire.superadmin.placeholders.users','livewire.superadmin.profile',
'livewire.superadmin.reports.index','livewire.superadmin.roles.index','livewire.superadmin.system-settings.content-section-editor','livewire.superadmin.system-settings.content-section-manager','livewire.superadmin.system-settings.course-manager',
'livewire.superadmin.system-settings.event-type-editor','livewire.superadmin.system-settings.event-type-manager','livewire.superadmin.system-settings.index','livewire.superadmin.system-settings.organization-manager','livewire.superadmin.system-settings.partials.organization-card',
'livewire.superadmin.system-settings.venue-editor','livewire.superadmin.system-settings.venue-manager','livewire.superadmin.tickets.index','livewire.superadmin.users.index','osa.welcome',
'reports.events-pdf','reports.gso.summary-pdf','reports.osa.summary-pdf','superadmin.archive','superadmin.dashboard',
'superadmin.logs','superadmin.reports','superadmin.roles','superadmin.settings','superadmin.users',
'volt-livewire::about-us','volt-livewire::avatar-selector','volt-livewire::components.event-calendar','volt-livewire::components.event-calendar-scripts','volt-livewire::components.ticket-comments',
'volt-livewire::faq','volt-livewire::gso.calendar','volt-livewire::gso.dashboard','volt-livewire::gso.details','volt-livewire::gso.notifications',
'volt-livewire::gso.profile','volt-livewire::gso.reports','volt-livewire::gso.ticket-review','volt-livewire::layout.navigation','volt-livewire::notification-dropdown',
'volt-livewire::osa.archive','volt-livewire::osa.archived-event-details','volt-livewire::osa.communication','volt-livewire::osa.dashboard','volt-livewire::osa.notifications',
'volt-livewire::osa.placeholders.communication','volt-livewire::osa.placeholders.dashboard','volt-livewire::osa.placeholders.event-calendar','volt-livewire::osa.placeholders.notifications','volt-livewire::osa.placeholders.stats-grid',
'volt-livewire::osa.placeholders.table','volt-livewire::osa.placeholders.ticket-cards','volt-livewire::osa.placeholders.ticket-management','volt-livewire::osa.placeholders.ticket-review','volt-livewire::osa.profile',
'volt-livewire::osa.reports','volt-livewire::osa.ticket-management','volt-livewire::osa.ticket-review.index','volt-livewire::osa.ticket-review.show','volt-livewire::pages.auth.confirm-password',
...
'volt-livewire::placeholders.notification-list','volt-livewire::profile.delete-user-form','volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form','volt-livewire::session-timeout',
