...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\LEX FILES\plv 3rdyr\1er\softdev\Org-Events-Scheduling-System\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\LEX FILES\\plv 3rdyr\\1er\\softdev\\Org-Events-Scheduling-System\\public\\storage','ide-helper.filename','ide-helper.models_filename',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','livewire.class_namespace','livewire.view_path',
...
'livewire.legacy_model_binding','livewire.inject_assets','livewire.navigate.show_progress_bar','livewire.navigate.progress_bar_color','livewire.navigate.progress_bar_delay',
...
'mail.markdown.paths','mary.prefix','mary.route_prefix','mary.components.spotlight.class','queue.default',
...
'session.http_only','session.same_site','session.partitioned','session.warning_time','debugbar.enabled',
...
'blade-heroicons.attributes','image.driver','image.options.autoOrientation','image.options.decodeAnimation','image.options.blendingColor',
'image.options.strip','resend.api_key','resend.domain','resend.path','resend.webhook.secret',
...
'rich-text-laravel.editor','rich-text-laravel.editors.trix','tinker.commands','tinker.alias','tinker.dont_alias',);
...
'livewire.preview-file','resend.webhook','mary.toogle-sidebar','mary.spotlight','mary.upload','about-us','faq','profile',
'dashboard','keep-alive','admin.dashboard','admin.ticket','osa.ticket-review.index',
'osa.ticket-review.show','admin.calendar','admin.notifications','admin.reports','admin.archive',
'admin.profile','superadmin.dashboard','superadmin.users','superadmin.roles','superadmin.calendar',
'superadmin.tickets','superadmin.archive','superadmin.reports','superadmin.notifications','superadmin.system-settings',
...
'gso.profile','student-org.dashboard','student-org.submit-ticket','student-org.my-tickets','student-org.calendar',
'student-org.reschedule','student-org.notifications','student-org.history','student-org.profile','login',
'admin.login','student-org.login','gso.login','superadmin.login','register',
'password.request','password.reset','verification.notice','verification.verify','password.confirm',
'logout','logout.get','storage.local',);
...
'components.dashboard.quick-action-card','components.dashboard.stat-card','components.documentary-requirements','components.footer','components.forms.email-input',
...
'components.layouts.superadmin','components.notifications.list','components.terms_and_conditions','components.tickets.latest-remark','components.tickets.progress-badge',
'components.tickets.progress-section','components.tickets.review','components.tickets.sections.additional-info','components.tickets.sections.attachments-list','components.tickets.sections.budget-info',
'components.tickets.sections.event-details','components.tickets.sections.organization-info','components.tickets.sections.schedule-venue','components.tickets.ticket-actions','components.tickets.ticket-card',
'components.tickets.ticket-pagination','components.tickets.ticket-preview','components.tickets.ticketinfo','components.tickets.upc-events-card','components.trix-input',
'components.ui.action-message','components.ui.activity-item','components.ui.application-logo','components.ui.auth-session-status','components.ui.avatar',
'components.ui.danger-button','components.ui.dropdown','components.ui.dropdown-link','components.ui.empty-state','components.ui.input-error',
'components.ui.input-label','components.ui.modal','components.ui.nav-link','components.ui.primary-button','components.ui.responsive-nav-link',
'components.ui.secondary-button','components.ui.section-header','emails.password-changed','emails.reset-password','emails.tickets.gso-approved',
'emails.tickets.gso-for-revision','emails.tickets.gso-rejected','emails.tickets.ticket-amended','emails.tickets.ticket-approved','emails.tickets.ticket-comment',
'emails.tickets.ticket-for-revision','emails.tickets.ticket-forwarded-gso','emails.tickets.ticket-rejected','emails.tickets.ticket-revision-requested','emails.tickets.ticket-status-updated',
'emails.tickets.ticket-submitted','emails.verify-email','errors.401','errors.402','errors.403',
'errors.404','errors.419','errors.429','errors.500','errors.503',
'errors.layout','errors.minimal','livewire.about-us','livewire.avatar-selector','livewire.components.event-calendar',
...
'livewire.profile.update-profile-information-form','livewire.session-timeout','livewire.student-org.dashboard','livewire.student-org.edit-ticket','livewire.student-org.history',
'livewire.student-org.my-ticket','livewire.student-org.notifications','livewire.student-org.profile','livewire.student-org.reschedule','livewire.student-org.submit-ticket',
...
'livewire.superadmin.system-settings.venue-manager','livewire.superadmin.tickets.index','livewire.superadmin.users.index','osa.welcome','reports.events-pdf',
'reports.gso.summary-pdf','reports.osa.summary-pdf','superadmin.archive','superadmin.dashboard','superadmin.logs',
'superadmin.reports','superadmin.roles','superadmin.settings','superadmin.users','volt-livewire::about-us',
'volt-livewire::avatar-selector','volt-livewire::components.event-calendar','volt-livewire::components.event-calendar-scripts','volt-livewire::components.ticket-comments','volt-livewire::faq',
'volt-livewire::gso.calendar','volt-livewire::gso.dashboard','volt-livewire::gso.details','volt-livewire::gso.notifications','volt-livewire::gso.profile',
'volt-livewire::gso.reports','volt-livewire::gso.ticket-review','volt-livewire::layout.navigation','volt-livewire::notification-dropdown','volt-livewire::osa.archive',
'volt-livewire::osa.archived-event-details','volt-livewire::osa.communication','volt-livewire::osa.dashboard','volt-livewire::osa.notifications','volt-livewire::osa.placeholders.communication',
'volt-livewire::osa.placeholders.dashboard','volt-livewire::osa.placeholders.event-calendar','volt-livewire::osa.placeholders.notifications','volt-livewire::osa.placeholders.stats-grid','volt-livewire::osa.placeholders.table',
'volt-livewire::osa.placeholders.ticket-cards','volt-livewire::osa.placeholders.ticket-management','volt-livewire::osa.placeholders.ticket-review','volt-livewire::osa.profile','volt-livewire::osa.reports',
'volt-livewire::osa.ticket-management','volt-livewire::osa.ticket-review.index','volt-livewire::osa.ticket-review.show','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password',
'volt-livewire::pages.auth.login','volt-livewire::pages.auth.register','volt-livewire::pages.auth.reset-password','volt-livewire::pages.auth.verify-email','volt-livewire::placeholders.notification-list',
'volt-livewire::profile.delete-user-form','volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form','volt-livewire::session-timeout','volt-livewire::student-org.dashboard',
'volt-livewire::student-org.edit-ticket','volt-livewire::student-org.history','volt-livewire::student-org.my-ticket','volt-livewire::student-org.notifications','volt-livewire::student-org.profile',
'volt-livewire::student-org.reschedule','volt-livewire::student-org.submit-ticket','volt-livewire::superadmin.admin-tools.index','volt-livewire::superadmin.archive.index','volt-livewire::superadmin.calendar.index',
'volt-livewire::superadmin.dashboard','volt-livewire::superadmin.faq-editor','volt-livewire::superadmin.faq-manager','volt-livewire::superadmin.logs','volt-livewire::superadmin.notifications',
'volt-livewire::superadmin.placeholders.dashboard','volt-livewire::superadmin.placeholders.logs','volt-livewire::superadmin.placeholders.notifications','volt-livewire::superadmin.placeholders.reports','volt-livewire::superadmin.placeholders.users',
'volt-livewire::superadmin.profile','volt-livewire::superadmin.reports.index','volt-livewire::superadmin.roles.index','volt-livewire::superadmin.system-settings.content-section-editor','volt-livewire::superadmin.system-settings.content-section-manager',
'volt-livewire::superadmin.system-settings.course-manager','volt-livewire::superadmin.system-settings.event-type-editor','volt-livewire::superadmin.system-settings.event-type-manager','volt-livewire::superadmin.system-settings.index','volt-livewire::superadmin.system-settings.organization-manager',
'volt-livewire::superadmin.system-settings.partials.organization-card','volt-livewire::superadmin.system-settings.venue-editor','volt-livewire::superadmin.system-settings.venue-manager','volt-livewire::superadmin.tickets.index','volt-livewire::superadmin.users.index',
'71ffe14e2608a75a2cb5aed52d105549::styles','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'rich-text-laravel::attachment_galleries._attachment_gallery','rich-text-laravel::components.styles','rich-text-laravel::content',);
        registerArgumentsSet('translations', 
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.LEX FILES.plv 3rdyr.1er.softdev.Org-Events-Scheduling-System.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
